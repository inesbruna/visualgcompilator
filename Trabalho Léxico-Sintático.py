...
transicao_sintatico = {
    'ALGORITMO': {'S': ['NOME_ALGORITMO/VALOR_LITERAL', 'INICIALIZADOR']}, 
    'INICIO': {'COMANDOS': ['VAR']},  
    'FIMALGORITMO': {'COMANDOS': []}, 

    'VAR': {'VAR': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'OP_ATRIB', 'VALOR', 'COMANDOS'],
            'INICIALIZADOR': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'OP_DELIMITACAO', 'TIPO_DADO', 'COMANDOS']}, 
    'VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO': {'COMANDOS': ['OP_DELIMITACAO', 'TIPO_DADO', 'COMANDOS'],
                'VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO': []},

    'NOME_ALGORITMO/VALOR_LITERAL': {'NOME_ALGORITMO/VALOR_LITERAL': []},
...
def sintatico(cadeia):
    ...
    try:
        ...
        if len(pilha) == 0:
            estado = 'qf'
        if estado != 'qf':
            return trata_erro(topo, terminal)
    except Exception:
        return trata_erro(topo, terminal)
    return "aceito"
