...
transicao_sintatico = {
    ...
    'OP_SEP_MESMO_TIPO': {
        ...
        'MAISEXPRESSAO_FUNCAO2PARAMETRO_ESCOLHA_OC': [],
    ...
    'ABRE_COLCHETE': {
        ...
        'OP_ATRIB': ['VALOR_INT','POSSIVEL_CONTINUE', 'OP_ATRIB'],
    ...
    # ABS
    'ABS':{ 'EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO1PARAMETRO'],
        ...
        'EXPRESSAO_FUNCAO1PARAMETRO_ESCOLHA_OC': [ 'PARENTESES', 'ESCOLHA_OC_MAISEXPRESSAO'],
        ...
        'EXPRESSAO_FUNCAO2PARAMETRO_ESCOLHA_OC': [ 'PARENTESES', 'ESCOLHA_OC_MAISEXPRESSAO'],
        ...
        'EXPRESSAO_FUNCAO2PARAMETRO_PROCEDIMENTO': ['PARENTESES', 'PROCEDIMENTO_MAISEXPRESSAO'],
            ...
            'ESCOLHA_OC_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO1PARAMETRO_ESCOLHA_OC'],
    ...
    #QUAD
    'QUAD':{ 'EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO1PARAMETRO'],
             'PARENTESES': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','PARENTESES','FECHANDO_PARENTESES_FUNCAO1PARAMETRO'],
             'EXPRESSAO_FUNCAO1PARAMETRO': ['PARENTESES', 'MAISEXPRESSAO'],
    ...
    #RAIZQ
    'RAIZQ':{ 'EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO1PARAMETRO'],
              'PARENTESES': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO', 'PARENTESES', 'FECHANDO_PARENTESES_FUNCAO1PARAMETRO'],
              'EXPRESSAO_FUNCAO1PARAMETRO': ['PARENTESES', 'MAISEXPRESSAO'],
...
#Em construção, não apagar comentários
    #EXP
    ...
    #Coisas para consertar, quando tem parenteses envolvidos e não está dando para integrar com outras funções
    #Parte funcionando, parte não
    'EXP':{ 'EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO' ],
              'PARENTESES': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO', 'PARENTESES', 'FECHANDO_PARENTESES_FUNCAO1PARAMETRO'],
        ...
        'EXPRESSAO_FUNCAO1PARAMETRO_ENQUANTO': [ 'ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        'EXPRESSAO_FUNCAO1PARAMETRO_PARA': [ 'ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        'EXPRESSAO_FUNCAO1PARAMETRO_REPITA': [ 'ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        'EXPRESSAO_FUNCAO1PARAMETRO_SENAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        'EXPRESSAO_FUNCAO1PARAMETRO_SE': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        'EXPRESSAO_FUNCAO1PARAMETRO_ESCOLHA': [ 'ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        'EXPRESSAO_FUNCAO1PARAMETRO_ESCOLHA_OC': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        'EXPRESSAO_FUNCAO1PARAMETRO_FUNCAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        'EXPRESSAO_FUNCAO1PARAMETRO_PROCEDIMENTO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],

        'EXPRESSAO_FUNCAO2PARAMETRO_ENQUANTO': [ 'ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        'EXPRESSAO_FUNCAO2PARAMETRO_PARA': [ 'ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        'EXPRESSAO_FUNCAO2PARAMETRO_REPITA': [ 'ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        'EXPRESSAO_FUNCAO2PARAMETRO_SENAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        'EXPRESSAO_FUNCAO2PARAMETRO_SE': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        'EXPRESSAO_FUNCAO2PARAMETRO_ESCOLHA': [ 'ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        'EXPRESSAO_FUNCAO2PARAMETRO_ESCOLHA_OC': [ 'ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        'EXPRESSAO_FUNCAO2PARAMETRO_FUNCAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        'EXPRESSAO_FUNCAO2PARAMETRO_PROCEDIMENTO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
              
              'ENQUANTO_EXPRESSAO' : ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_ENQUANTO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
              'PARA_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_PARA', 'EXPRESSAO_FUNCAO1PARAMETRO'],
              'REPITA_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_REPITA', 'EXPRESSAO_FUNCAO1PARAMETRO'],
              'SENAO_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_SENAO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
              'SE_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_SE', 'EXPRESSAO_FUNCAO1PARAMETRO'],
              'ESCOLHA_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_ESCOLHA', 'EXPRESSAO_FUNCAO1PARAMETRO'],
              'ESCOLHA_OC_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_ESCOLHA_OC', 'EXPRESSAO_FUNCAO1PARAMETRO'],
             'FUNCAO_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_FUNCAO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
             'PROCEDIMENTO_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_PROCEDIMENTO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
              
          
           },

    #RANDI
    'RANDI':{ 'EXPRESSAO': ['ABRIR_PARENTESES_RANDI', 'VALOR_INTEIRO/VARIAVEL', 'FECHAR_PARENTESES_RANDI'],
            #Já consertei, agora sem bugs
            ...
            'ESCOLHA_OC_EXPRESSAO': ['ABRIR_PARENTESES_RANDI', 'VALOR_INTEIRO/VARIAVEL', 'FECHAR_PARENTESES_RANDI_ESCOLHA_OC'],
            ...
            'EXPRESSAO_FUNCAO1PARAMETRO_ESCOLHA_OC': ['ABRIR_PARENTESES_RANDI', 'VALOR_INTEIRO/VARIAVEL', 'FECHA_PARENTESES_ESPECIAL_ESCOLHA_OC'],
    ...
    'VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO': {
        ...
        'EXPRESSAO_FUNCAO1PARAMETRO_ESCOLHA_OC': ['MAISEXPRESSAO_FUNCAO1PARAMETRO_ESCOLHA_OC'],
        ...
        'EXPRESSAO_FUNCAO2PARAMETRO_ESCOLHA_OC': ['MAISEXPRESSAO_FUNCAO2PARAMETRO_ESCOLHA_OC'],
    ...
    'ABRE_PARENTESES': {
        ...
        'EXPRESSAO_FUNCAO1PARAMETRO_ESCOLHA_OC': ['PARENTESES', 'MAISEXPRESSAO_FUNCAO1PARAMETRO_ESCOLHA_OC'],
        ...
        'EXPRESSAO_FUNCAO2PARAMETRO_ESCOLHA_OC': ['PARENTESES', 'MAISEXPRESSAO_FUNCAO2PARAMETRO_ESCOLHA_OC'],
    ...
    'FECHA_PARENTESES': {
        ...
        'MAISEXPRESSAO_FUNCAO1PARAMETRO_ESCOLHA_OC': ['ESCOLHA_OC_MAISEXPRESSAO'],
   ...
   #     'MAISEXPRESSAO_FUNCAO2PARAMETRO_SE': [],
    #    'MAISEXPRESSAO_FUNCAO2PARAMETRO_ESCOLHA': [],
     ...
     #   'MAISEXPRESSAO_FUNCAO2PARAMETRO_PROCEDIMENTO': [],
        ...
        'FECHA_PARENTESES_ESPECIAL_ESCOLHA_OC': ['MAISEXPRESSAO_FUNCAO1PARAMETRO_ESCOLHA_OC'],
...
# Acho que isso  não existirá, foi confusão minha, não existe tipo caracter, é o mesmo que valor literal
#    'VALOR_CARACTERE': {
#        'EXPRESSAO': ['MAISEXPRESSAO'],
#        'EXPRESSAO_FUNCAO1PARAMETRO': ['MAISEXPRESSAO_FUNCAO1PARAMETRO'],
#     'EXPRESSAO_FUNCAO1PARAMETRO_ENQUANTO': [ 'MAISEXPRESSAO_FUNCAO1PARAMETRO_ENQUANTO'],
...
#    },
    ...
    'OP_ARIT/OP_CARACTERE': {
        ...
        'MAISEXPRESSAO_FUNCAO1PARAMETRO_ESCOLHA_OC': ['EXPRESSAO_FUNCAO1PARAMETRO_ESCOLHA_OC'],
        ...
        'MAISEXPRESSAO_FUNCAO2PARAMETRO_ESCOLHA_OC': ['EXPRESSAO_FUNCAO2PARAMETRO_ESCOLHA_OC'],
