...
#Em construção, não apagar comentários
 ...
 #   'EXP':{ 'EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO', 'OP_SEP_MESMO_TIPO', 'EXPRESSAO_FUNCAO1PARAMETRO' ],
  #            'PARENTESES': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO', 'PARENTESES', 'FECHANDO_PARENTESES_FUNCAO1PARAMETRO'],
   #           'EXPRESSAO_FUNCAO1PARAMETRO': ['PARENTESES', 'MAISEXPRESSAO'],
   ...
   #     'EXPRESSAO_FUNCAO2PARAMETRO_SENAO': ['PARENTESES', 'SENAO_MAISEXPRESSAO'],
      ...
      #  'EXPRESSAO_FUNCAO2PARAMETRO_PROCEDIMENTO': ['PARENTESES', 'PROCEDIMENTO_MAISEXPRESSAO'],
          ...
          #    'ENQUANTO_EXPRESSAO' : ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_ENQUANTO', 'OP_SEP_MESMO_TIPO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
         #     'PARA_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_PARA', 'OP_SEP_MESMO_TIPO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
        #      'REPITA_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_REPITA', 'OP_SEP_MESMO_TIPO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
         #     'SENAO_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_SENAO', 'OP_SEP_MESMO_TIPO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
         #     'SE_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_SE','OP_SEP_MESMO_TIPO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
         #     'ESCOLHA_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_ESCOLHA', 'OP_SEP_MESMO_TIPO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
         #     'ESCOLHA_OC_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_ESCOLHA_OC', 'OP_SEP_MESMO_TIPO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
         #     'FUNCAO_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_FUNCAO', 'OP_SEP_MESMO_TIPO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
         #     'PROCEDIMENTO_EXPRESSAO': ['ABRINDO_PARENTESES_FUNCAO1PARAMETRO','EXPRESSAO_FUNCAO2PARAMETRO_PROCEDIMENTO','OP_SEP_MESMO_TIPO', 'EXPRESSAO_FUNCAO1PARAMETRO'],
