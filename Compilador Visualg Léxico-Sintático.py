...
transicao_sintatico = {
    ...
    'LOGICO': {
        'TIPO_DADO': [], 'TIPO_DADO2': []
    },

    'ABRE_COLCHETE': {
        'LIMITADOR': ['VALOR_INT', 'OP_DIMENSAO_VETOR', 'VALOR_INT', 'COMPLEMENTAR2', 'DE', 'TIPO_DADO2']
    },
    ...
    'E': { 'OP_MAIS_DE_UMA_COMPARACAO' : ['COMPARACAO', 'OP_MAIS_DE_UMA_COMPARACAO'] },
    'OU': { 'OP_MAIS_DE_UMA_COMPARACAO' : ['COMPARACAO', 'OP_MAIS_DE_UMA_COMPARACAO'] },
    'NAO': { 'OP_MAIS_DE_UMA_COMPARACAO' : ['COMPARACAO', 'OP_MAIS_DE_UMA_COMPARACAO'] },
    'XOU': { 'OP_MAIS_DE_UMA_COMPARACAO' : ['COMPARACAO', 'OP_MAIS_DE_UMA_COMPARACAO'] },
    ...
    'PARA': {
        'COMANDOS': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'DE', 'VALOR_INT', 'ATE', 'VALOR_INT', 'FACA_PASSO', 'PARA_COMANDOS', 'COMANDOS'],
        'SE_COMANDOS': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'DE', 'VALOR_INT', 'ATE', 'VALOR_INT', 'FACA_PASSO', 'PARA_COMANDOS', 'SE_COMANDOS'],
        'SENAO_COMANDOS': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'DE', 'VALOR_INT', 'ATE', 'VALOR_INT', 'FACA_PASSO', 'PARA_COMANDOS', 'SENAO_COMANDOS'],
        'PARA_COMANDOS': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'DE', 'VALOR_INT', 'ATE', 'VALOR_INT', 'FACA_PASSO', 'PARA_COMANDOS', 'PARA_MAISEXPRESSAO'],
        'ENQUANTO_COMANDOS': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'DE', 'VALOR_INT', 'ATE', 'VALOR_INT', 'FACA_PASSO', 'PARA_COMANDOS', 'ENQUANTO_MAISEXPRESSAO'],
        'ESCOLHA_COMANDOS': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'DE', 'VALOR_INT', 'ATE', 'VALOR_INT', 'FACA_PASSO', 'PARA_COMANDOS', 'ESCOLHA_MAISEXPRESSAO'],
        'ESCOLHA_OC_COMANDOS': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'DE', 'VALOR_INT', 'ATE', 'VALOR_INT', 'FACA_PASSO', 'PARA_COMANDOS', 'ESCOLHA_OC_MAISEXPRESSAO'],

        'MAISEXPRESSAO': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'DE', 'VALOR_INT', 'ATE', 'VALOR_INT', 'FACA_PASSO', 'PARA_COMANDOS', 'COMANDOS'],
        'SE_MAISEXPRESSAO': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'DE', 'VALOR_INT', 'ATE', 'VALOR_INT', 'FACA_PASSO', 'PARA_COMANDOS', 'SE_COMANDOS'],
        'SENAO_MAISEXPRESSAO': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'DE', 'VALOR_INT', 'ATE', 'VALOR_INT', 'FACA_PASSO', 'PARA_COMANDOS', 'SENAO_COMANDOS'],
        'PARA_MAISEXPRESSAO': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'DE', 'VALOR_INT', 'ATE', 'VALOR_INT', 'FACA_PASSO', 'PARA_COMANDOS', 'PARA_COMANDOS'],
        'ENQUANTO_MAISEXPRESSAO': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'DE', 'VALOR_INT', 'ATE', 'VALOR_INT', 'FACA_PASSO', 'PARA_COMANDOS', 'ENQUANTO_COMANDOS'],
        'ESCOLHA_MAISEXPRESSAO': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'DE', 'VALOR_INT', 'ATE', 'VALOR_INT', 'FACA_PASSO', 'PARA_COMANDOS', 'ESCOLHA_COMANDOS'],
        'ESCOLHA_OC_MAISEXPRESSAO': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'DE', 'VALOR_INT', 'ATE', 'VALOR_INT', 'FACA_PASSO', 'PARA_COMANDOS', 'ESCOLHA_OC_COMANDOS']
    },
    ...
    'ENQUANTO': {
        ...
        'PARA_COMANDOS': ['COMPARACAO', 'FACA', 'ENQUANTO_COMANDOS', 'PARA_MAISEXPRESSAO'],
        'ENQUANTO_COMANDOS': ['COMPARACAO', 'FACA', 'ENQUANTO_COMANDOS', 'ENQUANTO_MAISEXPRESSAO'],
        'ESCOLHA_COMANDOS': ['COMPARACAO', 'FACA', 'ENQUANTO_COMANDOS', 'ESCOLHA_MAISEXPRESSAO'],
        'ESCOLHA_OC_COMANDOS': ['COMPARACAO', 'FACA', 'ENQUANTO_COMANDOS', 'ESCOLHA_OC_MAISEXPRESSAO'],
    ...
    'ESCOLHA': {
        ...
        'PARA_COMANDOS': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'CASO', 'VALOR_ESCOLHA', 'ESCOLHA_COMANDOS', 'PARA_MAISEXPRESSAO'],
        'ENQUANTO_COMANDOS': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'CASO', 'VALOR_ESCOLHA', 'ESCOLHA_COMANDOS', 'ENQUANTO_MAISEXPRESSAO'],
        'ESCOLHA_COMANDOS': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'CASO', 'VALOR_ESCOLHA', 'ESCOLHA_COMANDOS', 'ESCOLHA_MAISEXPRESSAO'],
        'ESCOLHA_OC_COMANDOS': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'CASO', 'VALOR_ESCOLHA', 'ESCOLHA_COMANDOS', 'ESCOLHA_OC_MAISEXPRESSAO'],
    ...
    'SE': {
        ...
        'SENAO_COMANDOS': ['COMPARACAO', 'ENTAO', 'SE_COMANDOS'],
...
def buscar_erro(simbolo, transicoes):
    for palavra, transicao in transicoes.items():
...
def trata_erro(topo, terminal, pilha):
    ...
    if palavra_esperada != None:
        ...
        return f'Erro: na palavra "{terminal}", Token Esperado: {topo}, \n\n\nPilha: "{pilha}"'
...
def sintatico(cadeia):
    ...
    try:
        ...
        if len(pilha) == 0:
            estado = 'qf'
        if estado != 'qf':
            return trata_erro(topo, terminal, pilha)
    except Exception:
        return trata_erro(topo, terminal, pilha)
    return "aceito."
