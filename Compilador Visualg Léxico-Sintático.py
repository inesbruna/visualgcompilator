...
transicao_sintatico = {
    ...
    'OP_SEP_MESMO_TIPO': {
        ...
        'ESCOLHA_COMANDOS': ['OP_ARIT', 'ESCOLHA_COMANDOS']
    },
    ...
    'NOME_ALGORITMO/VALOR_LITERAL': {
        ...
        'OP_ARIT/OP_CARACTERE': [], 
        'OP_ARIT': [], 
        'MOD': [], 'NOME_ALGORITMO/VALOR_LITERAL': [],
        'PARENTESES': ['FECHAPARENTESES']
    },
    ...
    'ENQUANTO': {
        ...
        'MAISEXPRESSAO': ['COMPARACAO', 'FACA', 'ENQUANTO_COMANDOS', 'COMANDOS'],
        'ENQUANTO_MAISEXPRESSAO': ['COMPARACAO', 'FACA', 'ENQUANTO_COMANDOS', 'COMANDOS']
    },
    ...
    'ESCOLHA': {
        'COMANDOS': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'CASO', 'OP_ARIT', 'ESCOLHA_COMANDOS', 'COMANDOS'],
        'MAISEXPRESSAO': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'CASO', 'OP_ARIT', 'ESCOLHA_COMANDOS', 'COMANDOS'],
        'PARA_COMANDOS': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'CASO', 'OP_ARIT', 'ESCOLHA_COMANDOS', 'PARA_MAISEXPRESSAO'],
        'ENQUANTO_COMANDOS': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'CASO', 'OP_ARIT', 'ESCOLHA_COMANDOS', 'ENQUANTO_MAISEXPRESSAO'],
        'ESCOLHA_COMANDOS': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'CASO', 'OP_ARIT', 'ESCOLHA_COMANDOS', 'ESCOLHA_MAISEXPRESSAO'],
        'ESCOLHA_OC_COMANDOS': ['VARIAVEL/NOME_DE_FUNCAO/NOME_DE_PROCEDIMENTO', 'CASO', 'OP_ARIT', 'ESCOLHA_COMANDOS', 'ESCOLHA_OC_MAISEXPRESSAO'],
    },

    'CASO': {
        'CASO': [],
        'ESCOLHA_COMANDOS': ['OP_ARIT', 'ESCOLHA_COMANDOS'],
        'ESCOLHA_MAISEXPRESSAO': ['OP_ARIT', 'ESCOLHA_COMANDOS']
    },
...
}  # FECHA O dicionário transição_pilha
...
def trata_erro(topo, terminal, pilha):
    ...
    if palavra_esperada != None:
        ...
        return f'Erro: na palavra "{terminal}", Token Esperado: {topo}, Pilha: "{pilha}"'
